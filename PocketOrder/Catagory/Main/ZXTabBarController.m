...
- (void)setUpAllChildViewController{
    ...
    [self setUpOneChildViewController:twoVC image:[UIImage imageNamed:@"nav02-normal"] selectImage:[UIImage imageNamed:@"nav02-click"] title:nil];
    // 3.添加购物车
    ZXThirdController *threeVC = [[ZXThirdController alloc]init];
    [self setUpOneChildViewController:threeVC image:[UIImage imageNamed:@"nav03-normal"] selectImage:[UIImage imageNamed:@"nav03-click"] title:nil];
    // 4.添加个人中心
    ZXFourthController *fourVC = [[ZXFourthController alloc]init];
