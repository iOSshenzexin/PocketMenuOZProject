...
{
    [self addChildViewController:[[ZXAllOrderController alloc] init]];
    [self addChildViewController:[[ZXWaitingPaymentController alloc] init]];
    [self addChildViewController:[[ZXPaidController alloc] init]];
    [self addChildViewController:[[ZXWaitingEvaluatedController alloc] init]];
    [self addChildViewController:[[ZXEvaluatedController alloc] init]];
}
