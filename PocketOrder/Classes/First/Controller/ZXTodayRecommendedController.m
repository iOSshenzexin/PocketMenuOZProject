//
//  ZXTodayRecommendedController.m
//  PocketOrder
//
...
@interface ZXTodayRecommendedController ()<UIScrollViewDelegate>
...
@implementation ZXTodayRecommendedController
...
{
    [self addChildViewController:[[ZXGuessYouLikeStoreController alloc] init]];
    [self addChildViewController:[[ZXGuessYouLikeGroupController alloc] init]];
}
