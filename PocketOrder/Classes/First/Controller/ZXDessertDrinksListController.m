...
{
    _ShopCartView = [[ShoppingCartView alloc] initWithFrame:CGRectMake(0, ScreenH - ShopCarViewHeight - 64, ScreenW, ShopCarViewHeight) inView:self.view withObjects:nil];
