//
//  ZXDessertAndDrinksController.m
//  PocketOrder
//
...
@interface ZXDessertAndDrinksController ()<LSSelectMenuViewDelegate,LSSelectMenuViewDataSource,UITableViewDelegate,UITableViewDataSource>{
...
@implementation ZXDessertAndDrinksController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self setupMenuView];
    [self setupNavigationBarBtn];
    self.listArray = [NSMutableArray arrayWithObjects:@"商家分类",@"蛋糕",@"蛋挞",@"茶",@"饮料",@"最新入驻",nil];
}
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    ZXDessertDrinksCell *cell = [ZXDessertDrinksCell cellWithTableView:tableView];
    return cell;
}
...
//        ZXFoodMerchantsCell *cell = [tableView cellForRowAtIndexPath:indexPath];
        ZXDessertDrinksListController *vc = [[ZXDessertDrinksListController alloc] init];
        vc.title = @"优一果·榴莲甜品店 (大拇指店)";
        [self.navigationController pushViewController:vc animated:YES];
    }
}
