...
#define kItemSelectedWidth  100
#define kItemSelectedHeight 100
...
- (void)setupScrollView{
    ...
    for (ZXMovie *movie in self.movies) {
        UIView *itemView = [[UIView alloc] initWithFrame:CGRectMake((kItemSpacing + kItemWidth) * i + kItemSpacing, 30, kItemWidth, kItemHeight)];
        [_scrollView addSubview:itemView];
        
        UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kItemWidth, kItemHeight)];
        imageView.backgroundColor = [UIColor whiteColor];
        imageView.layer.cornerRadius = kItemWidth * 0.5;
...
- (void)adjustSubviews:(UIScrollView *)scrollView{
    ...
    if (self.movies.count > 0) {
        ...
        if (scale < 0.0) {
            ...
            leftView.layer.cornerRadius = width *0.5;
            leftView.layer.masksToBounds = YES;
            //
//            leftView.layer.borderWidth = 10.0;
//            leftView.layer.borderColor = [UIColor whiteColor].CGColor;
            if (index + 1 < self.movies.count) {
                ...
                rightView.layer.cornerRadius = width * 0.5;
                rightView.layer.masksToBounds = YES;
                //
                rightView.layer.borderWidth = 8.0;
            ...
            if (index + 1 >= self.movies.count) {
                ...
                leftView.layer.masksToBounds = YES;
                //
                leftView.layer.borderWidth = 8.0;
                leftView.layer.borderColor = [UIColor whiteColor].CGColor;
